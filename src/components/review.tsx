          ...
          <div className="h-full w-full rounded-[15px] border border-gray-200 bg-gray-50">
            <div className="flex max-w-full flex-row gap-3 rounded-md p-3">
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <p className="text-sm "> Reviewed Date Posted | Time</p>
                </div>
                <label className="pb-1">
                  <input type="checkbox" value="" className="peer sr-only" />
                  <p className="line-clamp-2 cursor-pointer pt-2 text-sm peer-checked:line-clamp-none">
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
            ...
            <div className="flex max-w-full flex-row gap-3 rounded-md p-3">
              ...
              <div className="flex flex-col">
                ...
                <label className="pb-1">
                  <input type="checkbox" value="" className="peer sr-only" />
                  <p className="line-clamp-2 cursor-pointer pt-2 text-sm transition peer-checked:line-clamp-none">
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
                    twink earrings wwx twink earrings wwx twink earrings wwx
